        ...
        <div className="flex h-screen w-full bg-white overflow-hidden font-sans">
            <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 overflow-y-auto">
                <div className="w-full max-w-md mx-auto">
                    ...
                    <h1 className="text-3xl font-extrabold text-gray-900 mb-4">Content de vous revoir !</h1>
                    <h2 className="text-gray-600 text-lg mb-8 font-medium">Connectez-vous à votre compte</h2>

                    {/* Gestion erreur automatique via mutation.isError */}
                    {mutation.isError && (
                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="pt-2">
                            <button
                                type="submit"
                                // Utilisation de mutation.isPending
                        ...
                        <span className="ml-4 text-sm text-gray-400 inline-block"><p>Pas encore de compte ?</p></span>
                        <span className="ml-4 text-sm text-gray-400">
            ...
            <div className="hidden md:block md:w-1/2 relative bg-teal-900">
                <img src={sideIllustration} alt="Illustration Finance" className="absolute inset-0 w-full h-full object-cover" />
